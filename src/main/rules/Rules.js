...
function Rules() {
    ...
    return (
        <div style={rulesStyle}>
            ...
            <br />
            5.Трипкоды и аватарки разрешены только в&nbsp;<Link to="/board?board=rf">/rf/</Link>.
            <br />
            6.Обсуждение работы модерации сайта запрещено на всех досках, кроме&nbsp;<Link to="/board?board=s">/s/</Link>.&nbsp;Нарушение данного правила может повлечь за собой бан.
        </div>
    );
}
